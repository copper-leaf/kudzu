...
class Sequence7Parser<T1 : Node, T2 : Node, T3 : Node, T4 : Node, T5 : Node, T6 : Node, T7 : Node>(
    ...
    override val parse =
        DeepRecursiveFunction<ParserContext, ParserResult<Sequence7Node<T1, T2, T3, T4, T5, T6, T7>>> { input ->
