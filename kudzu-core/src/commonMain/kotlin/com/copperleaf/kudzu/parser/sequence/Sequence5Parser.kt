 ...
 */
public class Sequence5Parser<T1 : Node, T2 : Node, T3 : Node, T4 : Node, T5 : Node>(
    ...
    override val parse: ParseFunction<Sequence5Node<T1, T2, T3, T4, T5>> = runParser { input ->
