 ...
 */
public class Sequence8Node<T1 : Node, T2 : Node, T3 : Node, T4 : Node, T5 : Node, T6 : Node, T7 : Node, T8 : Node>(
    public val node1: T1,
    public val node2: T2,
    public val node3: T3,
    public val node4: T4,
    ...
    public operator fun component8(): T7 = node7
    public operator fun component9(): T8 = node8
}
